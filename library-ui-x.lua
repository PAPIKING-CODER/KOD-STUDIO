...
function Library.GradientImage(E : Frame , Color)
	...
	GLImage.ImageColor3 = Color or Color3.fromRGB(220, 25, 25)  -- RED ACCENT
...
function Library.new(config)
	...
	local function Update()
		if WindowTable.WindowToggle then
			Twen:Create(MainFrame,TweenInfo.new(1.5,Enum.EasingStyle.Quint),{BackgroundTransparency = 0.85,Size = config.Size}):Play();
			...
			Twen:Create(UICorner,TweenInfo.new(1),{
				CornerRadius = UDim.new(0, 8) -- more premium
			}):Play()
	...
	MainFrame.BackgroundColor3 = Color3.fromRGB(8, 8, 8)  -- Main background
	...
	Twen:Create(MainFrame,TweenInfo1,{BackgroundTransparency = 0.85,Size = config.Size}):Play();
	...
	Headers.BackgroundColor3 = Color3.fromRGB(14, 14, 14)  -- Header
	...
	Title.TextColor3 = Color3.fromRGB(255, 255, 255)  -- Primary text
	...
	Description.TextColor3 = Color3.fromRGB(170, 170, 170)  -- Secondary text
	...
	BlockFrame1.BackgroundColor3 = Color3.fromRGB(45, 10, 10)  -- Border
	...
	BlockFrame3.BackgroundColor3 = Color3.fromRGB(45, 10, 10)  -- Border
	...
	BlockFrame2.BackgroundColor3 = Color3.fromRGB(45, 10, 10)  -- Border
	...
	TabButtonFrame.BackgroundColor3 = Color3.fromRGB(18, 18, 18)  -- Panels
	...
	UICorner_6.CornerRadius = UDim.new(0, 6)  -- more premium
	...
	MainTabFrame.BackgroundColor3 = Color3.fromRGB(18, 18, 18)  -- Panels
	...
	UICorner_7.CornerRadius = UDim.new(0, 6)  -- more premium
	...
	task.spawn(function()
		...
		DropdownFrame.BackgroundColor3 = Color3.fromRGB(8, 8, 8)  -- Main background
		...
		UIStroke.Color = Color3.fromRGB(45, 10, 10)  -- Border
		...
		local GetSelector = function(title,value)
			...
			Selector.BackgroundColor3 = Color3.fromRGB(8, 8, 8)  -- Main background
			...
			Frame.BackgroundColor3 = Color3.fromRGB(220, 25, 25)  -- Accent
	...
	function WindowTable:NewTab(cfg)
		...
		UICorner.CornerRadius = UDim.new(0, 6)  -- more premium
		...
		function TabTable:NewSection(c_o_n_f_i_g)
			...
			Section.BackgroundColor3 = Color3.fromRGB(18, 18, 18)  -- Panels
			...
			Header.BackgroundColor3 = Color3.fromRGB(14, 14, 14)  -- Header
			...
			BlockFrame.BackgroundColor3 = Color3.fromRGB(45, 10, 10)  -- Border
			...
			function SectionTable:NewToggle(toggle)
				...
				FunctionToggle.BackgroundColor3 = Color3.fromRGB(24, 24, 24)  -- Secondary Panels
				...
				TextInt.TextColor3 = Color3.fromRGB(255, 255, 255)  -- Primary text
				...
				System.BackgroundColor3 = Color3.fromRGB(45, 45, 45)  -- Toggle OFF
				...
				UIStroke_2.Color = Color3.fromRGB(45, 10, 10)  -- Border
				UIStroke_2.Parent = System

				Icon.Name = "Icon"
				Icon.Parent = System
				Icon.AnchorPoint = Vector2.new(0.5, 0.5)
				Icon.BackgroundColor3 = Color3.fromRGB(235, 30, 30)  -- Toggle ON
				...
				UICorner_3.CornerRadius = UDim.new(0, 4)  -- more premium
			...
			function SectionTable:NewTitle(lrm)
				...
				FunctionTitle.BackgroundColor3 = Color3.fromRGB(24, 24, 24)  -- Secondary Panels
				...
				UICorner.CornerRadius = UDim.new(0, 4)  -- more premium
			...
			function SectionTable:NewButton(cfg)
				...
				FunctionButton.BackgroundColor3 = Color3.fromRGB(24, 24, 24)  -- Secondary Panels
			...
			function SectionTable:NewKeybind(ctfx)
				...
				FunctionKeybind.BackgroundColor3 = Color3.fromRGB(24, 24, 24)  -- Secondary Panels
				...
				Bindkey.TextColor3 = Color3.fromRGB(255, 255, 255)  -- Primary text
				Bindkey.TextScaled = true
				Bindkey.TextSize = 14.000
				Bindkey.TextTransparency = 0.500
				Bindkey.TextWrapped = true

				UICorner_2.CornerRadius = UDim.new(0, 4)  -- more premium
			...
			function SectionTable:NewSlider(slider)
				...
				FunctionSlider.BackgroundColor3 = Color3.fromRGB(24, 24, 24)  -- Secondary Panels
				...
				ValueText.TextColor3 = Color3.fromRGB(170, 170, 170)  -- Secondary text
				...
				MFrame.BackgroundColor3 = Color3.fromRGB(8, 8, 8)  -- Main background
				...
				TFrame.BackgroundColor3 = Color3.fromRGB(220, 25, 25)  -- Accent
			...
			function SectionTable:NewDropdown(drop)
				...
				FunctionDropdown.BackgroundColor3 = Color3.fromRGB(24, 24, 24)  -- Secondary Panels
				...
				ValueText.TextColor3 = Color3.fromRGB(255, 255, 255)  -- Primary text
				ValueText.TextScaled = true
				ValueText.TextSize = 14.000
				ValueText.TextTransparency = 0.500
				ValueText.TextWrapped = true
			...
			function SectionTable:NewTextbox(conf)
				...
				FunctionTextbox.BackgroundColor3 = Color3.fromRGB(24, 24, 24)  -- Secondary Panels
				...
				FileType.TextColor3 = Color3.fromRGB(170, 170, 170)  -- Secondary text
				...
				TextBox.TextColor3 = Color3.fromRGB(255, 255, 255)  -- Primary text
...
Library.NewAuth = function(conf)
	...
	Auth.BackgroundColor3 = Color3.fromRGB(8, 8, 8)  -- Main background
	...
	local cose = {Library.GradientImage(MainFrame),
		Library.GradientImage(MainFrame,Color3.fromRGB(220, 25, 25))}  -- Red accent

	MainFrame.Name = "MainFrame"
	MainFrame.Parent = Auth
	MainFrame.Active = true
	MainFrame.AnchorPoint = Vector2.new(0.5, 0.5)
	MainFrame.BackgroundColor3 = Color3.fromRGB(14, 14, 14)  -- Header
	...
	Button2.BackgroundColor3 = Color3.fromRGB(24, 24, 24)  -- Secondary Panels
	...
	Button2.TextColor3 = Color3.fromRGB(255, 255, 255)  -- Primary text
	...
	TextBox.AnchorPoint = Vector2.new(0.5, 0.5)
	TextBox.BackgroundColor3 = Color3.fromRGB(8, 8, 8)  -- Main background
	...
	UICorner_4.CornerRadius = UDim.new(0, 4)  -- more premium
	...
	Button1.BackgroundColor3 = Color3.fromRGB(24, 24, 24)  -- Secondary Panels
	...
	Button1.TextColor3 = Color3.fromRGB(255, 255, 255)  -- Primary text
	Button1.TextSize = 14.000

	UICorner_5.CornerRadius = UDim.new(0, 4)  -- more premium
	...
	UIStroke_3.Color = Color3.fromRGB(45, 10, 10)  -- Border
...
Library.Notification = function()
	...
	return {
		new = function(ctfx)
			...
			Notifiy.BackgroundColor3 = Color3.fromRGB(8, 8, 8)  -- Main background
			...
			TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255)  -- Primary text
			...
			TextLabel_2.TextColor3 = Color3.fromRGB(170, 170, 170)  -- Secondary text
...
function Library:Console()
	...
	MFrame.AnchorPoint = Vector2.new(0.5, 0.5)
	MFrame.BackgroundColor3 = Color3.fromRGB(14, 14, 14)  -- Header
	...
	konsole_title.TextColor3 = Color3.fromRGB(255, 255, 255)  -- Primary text
	...
	KFrame.BackgroundColor3 = Color3.fromRGB(18, 18, 18)  -- Panels
	...
	Frame.Parent = KFrame
	Frame.BackgroundColor3 = Color3.fromRGB(45, 10, 10)  -- Border
	Frame.BorderColor3 = Color3.fromRGB(0, 0, 0)
	Frame.BorderSizePixel = 0
	...
	cmdFrame.BorderColor3 = Color3.fromRGB(45, 10, 10)  -- Border
	...
	Frame_2.BackgroundColor3 = Color3.fromRGB(45, 10, 10)  -- Border
	...
	local mkLine = function()
		...
		StartK.TextColor3 = Color3.fromRGB(255, 255, 255)  -- Primary text
		...
		TitleK.Text = "failed"
		TitleK.TextColor3 = Color3.fromRGB(255, 255, 255)  -- Primary text
